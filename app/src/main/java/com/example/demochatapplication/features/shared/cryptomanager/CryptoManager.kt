package com.example.demochatapplication.features.shared.cryptomanager
...
class CryptoManager @Inject constructor() {
    ...
    fun encrypt(bytes: ByteArray, outputStream: OutputStream): ByteArray {
        ...
        // we need iv that was generated with `encryptCipher` for decryption
        // common way to do is by appending iv in front of the encrypted bytes
        outputStream.use {
